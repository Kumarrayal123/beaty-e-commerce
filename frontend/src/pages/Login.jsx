  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      if (currentState === 'Sign Up') {
        const response = await axios.post("https://backend-one-smoky-52.vercel.app/api/user/register", { name, email, password });
        ...
        const response = await axios.post("https://backend-one-smoky-52.vercel.app/api/user/login", { email, password });

...
const PlaceOrder = () => {
  ...
  const apiURL = 'https://backend-one-smoky-52.vercel.app/api/makePayment';
  const makePayment = async ()=>{
    const strips = await loadStripe('pk_test_51QnHSMHw1rxZkPsd7dfMPiIhUdKq89IeC55oKo0NFzAv8enMfNXCIVpB2ybJRx135fmGu9NYSOaMMYh1i7ajqu1o00FXvFVGbv')
    ...
    const result = strips.redirectToCheckout({

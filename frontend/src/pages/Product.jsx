...
//       // Fetch related products with the same name but different IDs
//       const related = products.filter(
//         (item) =>
//           item.name === foundProduct.name && item._id !== foundProduct._id
//       );
...
//   const handleAddToCart = () => {
//     if (size && color) {
//       addToCart(productData._id, size, color);  // Pass the selected color along with size
//       navigate('/cart');
//     } else {
...
//               {productData.colors?.map((item, index) => (
//                 <button
//                   onClick={() => setColor(item)}  // Update the color
